...
class MainWindow(QMainWindow):
    ...
    def _setup_connections(self) -> None:
        ...
        self.signal_monitor_view.signal_explain_requested.connect(self._on_signal_explain_requested)
    ...
    def _start_plc(self) -> None:
        ...
        if not self.plc._running:
            ...
            QMessageBox.information(
                self, "PLC Start", "PLC Simulation gestartet!\n\nDie Prozesssimulation läuft jetzt."
            )
            self._update_plc_button_states()
        else:
            QMessageBox.warning(self, "PLC Start", "PLC läuft bereits!")
    ...
    def _stop_plc(self) -> None:
        ...
        if self.plc._running:
            ...
            if reply == QMessageBox.Yes:
                ...
                QMessageBox.information(self, "PLC Stop", "PLC Simulation gestoppt!")
                self._update_plc_button_states()
        else:
            QMessageBox.warning(self, "PLC Stop", "PLC läuft nicht!")
    ...
    def _reset_plc(self) -> None:
        ...
        if reply == QMessageBox.Yes:
            ...
            QMessageBox.information(
                self, "PLC Reset", "PLC wurde zurückgesetzt!\n\nAlle Ausgänge sind jetzt AUS."
            )
