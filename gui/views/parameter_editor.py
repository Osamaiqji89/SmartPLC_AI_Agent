...
class ParameterDialog(QDialog):
    ...
    def _validate_and_accept(self) -> None:
        ...
        if not (min_val <= value <= max_val):
            QMessageBox.warning(
                self, "Validation Error", f"Value must be between {min_val} and {max_val}!"
            )
            return
...
class ParameterEditorView(QWidget):
    ...
    def _load_parameters(self) -> None:
        ...
        try:
            ...
            QMessageBox.critical(self, "Database Error", f"Failed to load parameters:\n{str(e)}")
    ...
    def _add_parameter(self) -> None:
        ...
        if dialog.exec() == QDialog.Accepted:
            ...
            try:
                ...
                if existing:
                    QMessageBox.warning(
                        self, "Duplicate Parameter", f"Parameter '{data['name']}' already exists!"
                    )
                    session.close()
                    return
                ...
                QMessageBox.information(
                    self, "Success", f"Parameter '{data['name']}' added successfully!"
                )
                ...
                QMessageBox.critical(self, "Database Error", f"Failed to add parameter:\n{str(e)}")
        ...
        if dialog.exec() == QDialog.Accepted:
            ...
            try:
                ...
                if param:
                    ...
                    QMessageBox.information(
                        self, "Success", f"Parameter '{data['name']}' updated successfully!"
                    )
                ...
                QMessageBox.critical(
                    self, "Database Error", f"Failed to update parameter:\n{str(e)}"
                )
        ...
        if reply == QMessageBox.Yes:
            try:
                ...
                if param:
                    ...
                    QMessageBox.information(
                        self, "Success", f"Parameter '{parameter.name}' deleted successfully!"
                    )
                ...
                QMessageBox.critical(
                    self, "Database Error", f"Failed to delete parameter:\n{str(e)}"
                )
    ...
    def _export_csv(self) -> None:
        ...
        try:
            ...
            QMessageBox.information(
                self, "Export Successful", f"Exported {len(parameters)} parameters to:\n{filename}"
            )
