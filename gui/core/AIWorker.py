...
class AIWorker(QThread):
    ...
    def _fallback_explanation(self, signal_metadata: dict) -> str:
        ...
        explanation += f"**Aktueller Wert:** {signal_metadata['current_value']} {signal_metadata['unit']}\n"
    ...
    def _chat(self) -> str:
        ...
        try:
            ...
            return "⚠️ OpenAI API nicht konfiguriert. Bitte setzen Sie den API-Key in der .env Datei."
