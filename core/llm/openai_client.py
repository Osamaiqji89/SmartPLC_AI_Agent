...
"""
                ...
                "function": {
                    ...
                    "parameters": {
                        ...
                        "properties": {
                            ...
                            "value": {
                                "type": "number",
                                "description": "Zu schreibender Wert"
                            }
                        },
    ...
    def chat(
        ...
        try:
            ...
            logger.info(f"Chat completion: {response.usage.total_tokens if response.usage else 0} tokens used")
            return result
    ...
    def diagnose_error(
        ...
        """
        user_query = f"Analysiere Fehlercode {error_code}. Was ist die Ursache und wie behebe ich ihn?"
